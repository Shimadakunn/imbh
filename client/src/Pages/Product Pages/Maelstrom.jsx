    ...
    return (
        <>
            ...
            {display.every((value) => !value)?(
              <Page>
                <Images>
                    <ImageFrame className="img1"><img src={`./img/14/7_3.webp`} onClick={() => handleImageClick(0)}/></ImageFrame>
                    <ImageFrame className="img2"><img src={`./img/14/7_8.webp`} onClick={() => handleImageClick(1)}/></ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/14/7_5.webp`} onClick={() => handleImageClick(2)}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/14/7_7.webp`} onClick={() => handleImageClick(3)}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
                        <h1>MAELSTROM</h1>
