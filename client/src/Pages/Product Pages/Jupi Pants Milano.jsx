              ...
              <Page>
                <Images>
                    <ImageFrame className="img1">
                      <img className="min" src={`./img/8.webp`} onClick={() => handleImageClick(0)}/>
                      <ProductName>
                        Front
                      </ProductName>
                    </ImageFrame>
                    <ImageFrame className="img2">
                      <img className="min" src={`./img/8/8_2.webp`} onClick={() => handleImageClick(1)}/>
                      <ProductName>
                        Back
                      </ProductName>
                    </ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/8/8_3.webp`} onClick={() => handleImageClick(2)}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/8/8_4.webp`} onClick={() => handleImageClick(3)}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
                        ...
                        <button onClick={() => {if(stockData[7]!==0){addToCart({ id: 8, name: "JUPITER (MILANO)", price: 285,size:"Jupi Milano:" + size})}}}>Add to Cart</button>
                    </Info>
                </InfoContainer>
              </Page>
            ):(
