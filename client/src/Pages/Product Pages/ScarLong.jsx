...
const {stockData} = useContext(CartContext);
    ...
    return (
        <>
            ...
            <Page>
                <Images>
                    <ImageFrame className="img1"><img src={`./img/12/12_4.webp`}/></ImageFrame>
                    <ImageFrame className="img2"><img src={`./img/12/12_5.webp`}/></ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/12/13_4.webp`}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/12/13_5.webp`}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
