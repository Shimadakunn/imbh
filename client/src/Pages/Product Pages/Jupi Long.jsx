              ...
              <Page>
                <Images>
                    <ImageFrame className="img1">
                      <img className="min" src={`./img/2.webp`} onClick={() => handleImageClick(0)}/>
                      <ProductName>
                        Front
                      </ProductName>
                    </ImageFrame>
                    <ImageFrame className="img2">
                      <img className="min" src={`./img/2/2_2.webp`} onClick={() => handleImageClick(1)}/>
                      <ProductName>
                        Back
                      </ProductName>
                    </ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/2/2_3.webp`} onClick={() => handleImageClick(2)}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/2/2_5.webp`} onClick={() => handleImageClick(3)}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
