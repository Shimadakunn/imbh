    ...
    return (
        <>
            ...
            {display.every((value) => !value)?(
              <Page>
                <Images>
                    <ImageFrame className="img1"><img src={`./img/5/5_5.webp`} onClick={() => handleImageClick(0)}/></ImageFrame>
                    <ImageFrame className="img2"><img src={`./img/5/5_6.webp`} onClick={() => handleImageClick(1)}/></ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/5/5_4.webp`} onClick={() => handleImageClick(2)}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/5/5_8.webp`} onClick={() => handleImageClick(3)}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
                        <h1>SHADOW MESH HOODIE ({selectedCategorie === 5 ? "BLACK" : "COPPER"})</h1>
                        <p className="description">100% POLYESTER MAILLE WITH CROCO PATTERN</p>
                        <p className="price">150€</p>
                        <p  className="stock">{selectedCategorie === 5 ? stockData[4] : stockData[5]} items left</p>
                        <div className="desc">The model is 165cm tall and wears an unique size. Length = 135cm. <br/>You will be able to communicate additional informations about your measurements when finalizing your order</div>
                        <div>
                          <Categories>
                        ...
                        <button disabled onClick={() => {if(selectedCategorie === 5 && stockData[4] !== 0 || selectedCategorie === 6 && stockData[5] !==0){addToCart({ id: selectedCategorie, name: selectedCategorie === 5 ? "SHADOW DRESS (BLACK)" : "SHADOW DRESS (COPPER)", price: 150, size: "null"})}}}>Sold Out</button>
                    </Info>
                </InfoContainer>
              </Page>
             ):(
