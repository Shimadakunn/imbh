...
function Puffer() {
    ...
    return (
        <>
            ...
            <Page>
                <Images>
                    <ImageFrame className="img1"><img src={`./img/5/5_9.jpg`}/></ImageFrame>
                    <ImageFrame className="img2"><img src={`./img/5/5_3.jpg`}/></ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/5/5_4.jpg`}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/5/5_2.jpg`}/></ImageFrame>
                </Images>
                <InfoContainer>
                    <Info>
                        ...
                        <div>
                          <Categories>
                            <img className={selectedCategorie === 5 ? "selected" : ""} src={`./img/5.png`} onClick={() => setSelectedCategorie(5)}/>
                            <img className={selectedCategorie === 6 ? "selected" : ""} src={`./img/6.png`} onClick={() => setSelectedCategorie(6)}/>
                          </Categories>
                        </div>
