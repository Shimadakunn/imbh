  ...
  const elementStyle = {
    ...
    return (
        <>
            ...
            <Page>
                <Images>
                    <ImageFrame className="img1"><img src={`./img/5/5_9.webp`}/></ImageFrame>
                    <ImageFrame className="img2"><img src={`./img/5/5_3.webp`}/></ImageFrame>
                    <ImageFrame className="img3"><img src={`./img/5/5_4.webp`}/></ImageFrame>
                    <ImageFrame className="img4"><img src={`./img/5/5_10.webp`}/></ImageFrame>
                </Images>
                <InfoContainer>
